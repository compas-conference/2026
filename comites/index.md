...
**Présidente** : Fabienne Boyer (LIG - Grenoble)

+ Luciana Arantes (UPMC - Paris)
+ Françoise Baude (I3S - Nice)
+ Bissyande Tegawende (SnT - Luxembourg)
+ Bouchenak Sara (LIRIS - Lyon)
+ Daniel Hagimont (IRIT - Toulouse)
+ Julia Lawall (INRIA - Paris)
+ Vania Marangozova (LIG - Grenoble)
+ Clémentine Maurice (CNRS-CRIStAL - Lille)
+ Anne-Cécile Orgerie (CNRS-IRISA - Rennes)
+ Nikos Parlavantzas (INSA - Rennes)
+ Guillaume Pierre (CNRS-IRISA - Rennes)
+ Thomas Ropars (LIG - Grenoble)
+ Teabe Boris (IRIT - Toulouse)
+ Mathieu Bacou (Telecom - Evry)
+ Yasmina Bouizem (LIUPPA - Bayonne)
+ Jonathan Lejeune (Lip6 - Paris)
+ Bertier Marin (INSA - Rennes)
+ Lemouel Frédéric (INSA - Lyon)
...
- Estimation of the energy consumption of AI-based multiagent systems<br>
...
*G. Plisson, G. Rosinosky, D. Balouek*
- Latency Aware and ressource-efficient bin pack autoscaling for distributed event queues : An application to microservices architectures<br>
...
*P. Houssel, O. Levillain, N. Dejon*
- Fork-nox: intra-kernel system security<br>
...
*M. Trochon*
- Application-aware I/O scheduling in HPC systems<br>
*S. Meurrens*
- Amélioration des performances I/O de lapplication Gysela<br>
*A. Lou-Poueyou*
